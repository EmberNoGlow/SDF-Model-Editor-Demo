...
class SDFSceneBuilder:
    ...
    def add_operation_with_auto_primitives(
        ...
        Example:
            ...
            #   └── Sphere (d2)
        """
        return add_operation_with_auto_primitives(
            self, operation_type, ui_name, auto_primitive_type, forced_op_id
        )
    ...
    def add_standalone_primitive(
        ...
        **kwargs
        ...
        """
        return add_standalone_primitive(
            self,
            primitive_type,
            position,
            size_or_radius,
    ...
    def change_primitive_type(
        ...
        """
        return change_primitive_type(
            builder, node_id, new_type, new_size_or_radius, **kwargs
        )
    ...
    def change_node_to_operation(
        ...
        """
        return change_node_to_operation(
            builder, node_id, operation_type, auto_primitive_type
        )
    ...
    def change_node_to_primitive(
        ...
        **kwargs
        ...
        """
        return change_node_to_primitive(
            builder,
            node_id,
            primitive_type,
            position,
    ...
    def reparent_node(
        ...
        node_id: str,
        new_parent_id: str,
        child_to_replace_id: Optional[str] = None,
    ) -> bool:
        """
