...
class Camera:
    ...
    def setup(self):
        ...
        self.orbit_center_offset_x = (
            self.cam_pan_x * self.right_x + self.cam_pan_y * self.up_x
        )
        self.orbit_center_offset_y = (
            self.cam_pan_x * self.right_y + self.cam_pan_y * self.up_y
        )
        self.orbit_center_offset_z = (
            self.cam_pan_x * self.right_z + self.cam_pan_y * self.up_z
        )
