...
cn = {
    ...
    "FOV_ANGLE": math.radians(
        75
    ),  # Field of View angle in radians - used for ray direction calculation in rendering
    ...
    "MIN_PITCH": -math.radians(
        90
    ),  # Minimum allowed pitch angle in radians (−90° - looking straight down)
    "MAX_PITCH": math.radians(
        90
    ),  # Maximum allowed pitch angle in radians (+90° - looking straight up)
